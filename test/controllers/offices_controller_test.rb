...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { adress: @office.adress, commerce_id: @office.commerce_id, name: @office.name, number: @office.number } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { adress: @office.adress, commerce_id: @office.commerce_id, name: @office.name, number: @office.number } }
